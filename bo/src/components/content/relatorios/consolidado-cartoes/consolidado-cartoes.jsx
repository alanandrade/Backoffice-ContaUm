...
import './consolidado-cartoes.css';
...
export default class ConsolidadoCartoes extends Component {
    render() {
        return (
            <div className="consolidadoCartoes">
                <ActionHeaderBox>
                    <TitlesBox>
                        <TitlePrimario>Consolidado de cartões</TitlePrimario>
                        <Subtitle>Relatório de consolidado de cartões</Subtitle>
                    </TitlesBox>
                    <ActionHeader>
                        <Link to="/Home">
