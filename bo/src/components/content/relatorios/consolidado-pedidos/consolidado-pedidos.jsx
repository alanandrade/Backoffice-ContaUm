...
import './consolidado-pedidos.css';
...
export default class ConsolidadoPedidos extends Component {
    render() {
        return (
            <div className="consolidadoPedidos">
                <ActionHeaderBox>
                    <TitlesBox>
                        <TitlePrimario>Consolidado de pedidos</TitlePrimario>
                        <Subtitle>Relatório de consolidado de pedidos</Subtitle>
                    </TitlesBox>
                    <ActionHeader>
                        <Link to="/Home">
                ...
                <div className="content">
                    <form>
                        <Row>
                            ...
                            <Input s={12} m={6} type='select' label="Tipo de retorno" defaultValue='Por quantidade'>
                                <option value='Por quantidade'>Por quantidade</option>
                                <option value='Por valor'>Por valor</option>
                            </Input>
                        </Row>
