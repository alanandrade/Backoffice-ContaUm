...
export default class RecargaCartao extends Component {
    render() {
        return (
            <div className="recarga-cartao">
                <ActionHeaderBox>
                    <TitlesBox>
                        <TitlePrimario>Recarga de Cartão</TitlePrimario>
                        <Subtitle>Lista de recargas de Cartões</Subtitle>
                    </TitlesBox>
                    <ActionHeader>
                        <Link to="/Home">
